...
class Main:
    ...
    def process_data(self):
        ...
        # # for col in df_count_labs.columns:
        # #     print(col)
        
        # count_faulty = df_count.select('count(allele_result)').collectAsList()
        # print(count_faulty)
        
        # count_labs_rows = df_count.select('count(1)').collectAsList()
        #         # 'count(1)')
        # print(count_labs_rows)
        # # print((count_faulty/ count_labs_rows) * 100)
